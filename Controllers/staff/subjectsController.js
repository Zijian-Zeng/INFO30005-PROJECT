...
const createSubject = async (req, res, next) => {
	try {
		...
		if (
			...
			return res
				.status(400)
				.json({ error: "Error! subject already exist." });
		}
...
// Join an already created subject in database
...
//Leave an existing subject in your account
...
//Get all enrolled ubjects in database for staff
