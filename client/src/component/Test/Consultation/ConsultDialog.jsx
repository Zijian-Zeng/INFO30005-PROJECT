        ...
        <Grid container>
          ...
          <Grid item xs={11}>
            <MuiPickersUtilsProvider utils={MomentUtils}>
              <KeyboardDateTimePicker
                label="Start Date"
                value={edit ? editingAppointment.startDate : startDate}
                onChange={(date) => {
                  if (edit) {
                    setEditingAppointment({
                      ...editingAppointment,
            ...
            <Slider
              ...
              onChange={(e, newValue) => {
                if (edit) {
                  setEditingAppointment({
                    ...editingAppointment,
                    endDate: getEndDate(editingAppointment.startDate, newValue),
                  });
                  return;
                }
          ...
          <Grid item xs={11}>
            <TextField
              ...
              variant="filled"
              required
              value={edit ? editingAppointment.location : location}
              onChange={(e) => {
                if (edit) {
                  setEditingAppointment({
                    ...editingAppointment,
          ...
          <Grid item xs={11}>
            <DialogContentText>
              Slot Available: {edit ? editingAppointment.slotsAvailable : slot}
            </DialogContentText>
            <br />
            <SlotSlider
              valueLabelDisplay="auto"
              ...
              aria-labelledby="discrete-slider"
              value={edit ? editingAppointment.slotsAvailable : slot}
              onChange={(e, newValue) => {
                if (edit) {
                  setEditingAppointment({
                    ...editingAppointment,
