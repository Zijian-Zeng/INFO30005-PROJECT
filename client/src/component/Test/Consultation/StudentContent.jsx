...
export default withStyles(style, { name: "Content" })(
  ({ children, appointmentData, classes, ...restProps }) => {
    ...
    const book = async () => {
      ...
      const res = await myFetch("/api/student/consult/book", "POST", body);
    ...
    const checkBooked = () => {
      ...
      return (
        userInfo.registeredConsult.filter((each) => each == appointmentData.id)
          .length > 0
      );
    };
            ...
            <List>
              ...
              <ListItem>
                <Fab
                  ...
                  color={checkBooked() ? "default" : "primary"}
                  onClick={book}
